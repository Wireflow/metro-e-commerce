...
export interface WebsiteSalesData {
  date: string;
  sales: number;
}
...
interface WebsiteSalesChartProps {
  ...
  endDate: string | Date;
  websiteSalesData: WebsiteSalesData[];
}
...
const WebsiteSalesChart = ({ websiteSalesData, startDate, endDate }: WebsiteSalesChartProps) => {
  ...
  const formatData = websiteSalesData.map(item => ({
...
export default WebsiteSalesChart;
